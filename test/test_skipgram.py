...
def __exec_trainer():
	# 备份参数文件
	params_file = "./models/skipgram_params.pkl"
	...
	model = sf.models.word2vec.SkipGram(vocab_size, hidden_size, window_size, corpus)
...
if __name__ == "__main__":
	...
	#	- train : 用神经网络学习数据集
	if len(sys.argv) != 2:
		log.info("[Usage]test_skipgram.py <eval>|<train>")
		sys.exit()
	if (sys.argv[1] == 'eval'):
		__exec_eval()
